...
// Todos los productos usan esta misma página, diferenciados por ?id=
...
export default function ProductPage() {
  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="bg-gradient-to-r from-blue-900 to-blue-800 dark:from-blue-950 dark:to-blue-900 border-b border-blue-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link
            href="/"
            className="flex items-center gap-2 text-white hover:text-blue-100 transition-all duration-300 ease-out hover:translate-x-1 w-fit"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-20 space-y-6">
              ...
              <div className="bg-card border border-border rounded-lg p-4">
                <h3 className="font-semibold text-foreground mb-3">Precios en tiendas</h3>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              <div className="flex items-start justify-between mb-4">
                <div>
                  <p className="text-sm font-medium text-muted-foreground mb-2">{product.category}</p>
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <p className="font-semibold text-foreground">{product.rating} de 5</p>
            ...
            {/* Specifications */}
            <div>
              <h2 className="text-xl font-semibold text-foreground mb-4">Especificaciones técnicas</h2>
        ...
        <div className="bg-card border border-border rounded-lg p-6 mb-12">
          <h2 className="text-xl font-semibold text-foreground mb-4">Historial de precios</h2>
          <PriceChart />
        </div>
